...
export default function Services() {
	return (
		<div className="flex flex-col flex-wrap gap-2 md:flex-row w-full max-w-8xl items-center container">
			{SERVICES.map((service) => {
				return (
					<div
						key={service.title}
						className="flex flex-col flex-1 justify-around p-4 w-[18rem] md:w-auto hover:cursor-pointer space-y-2 rounded-md border shadow-lg transition-colors drop-shadow-lg aspect-square border-muted group hover:bg-primary hover:text-primary-foreground"
					>
